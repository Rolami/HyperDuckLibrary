...
namespace HyperDuckLibrary.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(HyperDuckLibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Book != null ?
                        ...
                        Problem("Entity set 'HyperDuckLibraryContext.Book'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HyperDuckLibraryContext.Book'  is null.");
            }
            var book = await _context.Book.FindAsync(id);
            if (book != null)
            {
